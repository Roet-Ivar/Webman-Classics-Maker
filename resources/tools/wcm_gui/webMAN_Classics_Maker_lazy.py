...
class Main():
    ...
    def draw_game_listbox(self):
        ...
        game_list_box.config(activestyle='dotbox', borderwidth=0)
        game_list_frame.place(x=900 - 15, y=302, width=250, height=340)
    ...
    def init_labels_texts_buttons(self, main):
        ...
        entry_width = 280
        self.entry_field_title_id.place(x=int((self.text_box_spacing + self.iso_path_text_x_pos) * scaling),
                                        y=int(self.title_id_text_y_pos * scaling), width=entry_width)
        self.entry_field_title.place(x=int((self.text_box_spacing + self.iso_path_text_x_pos) * scaling),
                                     y=int(self.title_text_y_pos * scaling), width=entry_width)
        self.entry_field_filename.place(x=int((self.text_box_spacing + self.iso_path_text_x_pos) * scaling),
                                        y=int(self.filename_text_y_pos * scaling), width=entry_width)
        self.entry_field_iso_path.place(x=int((self.text_box_spacing + self.iso_path_text_x_pos) * scaling),
        ...
        self.save_button.place(x=int((self.text_box_spacing + self.iso_path_text_x_pos) * scaling),
                               y=int((self.iso_path_text_y_pos + 40) * scaling))
        self.build_button.place(
            x=int((button_spacing + 10 + self.text_box_spacing + self.iso_path_text_x_pos) * scaling),
            y=int((self.iso_path_text_y_pos + 40) * scaling))
        ##########################################################################
